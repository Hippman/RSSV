...
public class ResporgPieReport {
    ...
    public ResporgPieReport( Date datefrom, Date dateto, Integer bound, List<ResporgPieRow> rows, Connection connection, PieChartModel pieModel) {
    ...
    public void genReport(){
            ...
            String reportName="Pie Resporg report by minutes ("+df.format(datefrom)+" to "+df.format(dateto)+")";
            pieModel1.setTitle(reportName);
            pieModel1.setLegendPosition("w");
            pieModel1.setShadow(true);
            
           
            reportName="Pie Resporg report by count ("+df.format(datefrom)+" to "+df.format(dateto)+")";
            pieModel2.setTitle(reportName);
            pieModel2.setLegendPosition("w");
            pieModel2.setShadow(true);
            
            pieModel1.set("test", 100);
            pieModel1.set("test2", 50);
