...
public class CICPieReport {
    ...
    public CICPieReport( Date datefrom, Date dateto, Integer bound, List<ResporgPieRow> rows, Connection connection, PieChartModel pieModel) {
    ...
    public void genReport(){
            ...
            String reportName="Pie CIC report by minutes ("+df.format(datefrom)+" to "+df.format(dateto)+")";
            pieModel1.setTitle(reportName);
            pieModel1.setLegendPosition("w");
            pieModel1.setShadow(true);
            
        
            reportName="Pie CIC report by count ("+df.format(datefrom)+" to "+df.format(dateto)+")";
